...
public class VistaCliente extends javax.swing.JFrame {
    ...
    public VistaCliente() {
        initComponents();
        this.nombre.setText(Configuracion.arrProductos.getArregloP()[7].getNombreProducto());
        this.estado.setText(Configuracion.arrProductos.getArregloP()[7].getEstado());
        //aqui intento cambiar el tamaño del icono
        Icon nuevoIcono=scaleImage((ImageIcon) Configuracion.arrProductos.getArregloP()[7].getImagen(),foto.getWidth(),foto.getHeight());
        this.foto.setIcon(nuevoIcono);
        this.codigobarras.setIcon(Configuracion.arrProductos.getArregloP()[7].getImagenBarras());
    }
    ...
    private void initComponents() {
        ...
        codigobarras.setText("jLabel1");

        estado.setText("jLabel1");

        nombre.setText("jLabel1");

        nombre1.setText("MINIMICEN ESTO XD");
        ...
        jPanel1Layout.setHorizontalGroup(
            ...
            .addGroup(jPanel1Layout.createSequentialGroup()
                .addGap(75, 75, 75)
                .addComponent(codigobarras, javax.swing.GroupLayout.PREFERRED_SIZE, 179, javax.swing.GroupLayout.PREFERRED_SIZE)
            ...
            .addGroup(jPanel1Layout.createSequentialGroup()
                .addGroup(jPanel1Layout.createParallelGroup(javax.swing.GroupLayout.Alignment.LEADING)
                    ...
                    .addGroup(jPanel1Layout.createSequentialGroup()
                        .addGap(181, 181, 181)
                        .addComponent(nombre1, javax.swing.GroupLayout.PREFERRED_SIZE, 128, javax.swing.GroupLayout.PREFERRED_SIZE)))
            ...
            .addGroup(javax.swing.GroupLayout.Alignment.TRAILING, jPanel1Layout.createSequentialGroup()
                .addGroup(jPanel1Layout.createParallelGroup(javax.swing.GroupLayout.Alignment.TRAILING)
                    ...
                    .addGroup(jPanel1Layout.createSequentialGroup()
                        ...
                        .addComponent(codigobarras, javax.swing.GroupLayout.PREFERRED_SIZE, 122, javax.swing.GroupLayout.PREFERRED_SIZE)
                        .addGap(65, 65, 65)))
                .addComponent(foto, javax.swing.GroupLayout.PREFERRED_SIZE, 133, javax.swing.GroupLayout.PREFERRED_SIZE)
                .addGap(52, 52, 52))
        );

        getContentPane().add(jPanel1, new org.netbeans.lib.awtextra.AbsoluteConstraints(-2, -5, 580, 460));
